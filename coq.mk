...
##########################################################################
## GNUMakefile for Coq 8.16+alpha
...
coq.mk.conf: _CoqProject
	coq_makefile -o coq.mk -f _CoqProject

# This file can be created by the user to hook into double colon rules or
# add any other Makefile code he may need
-include coq.mk.local

# Parameters ##################################################################
#
# Parameters are make variable assignments.
# They can be passed to (each call to) make on the command line.
# They can also be put in coq.mk.local once and for all.
...
# put in coq.mk.local double colon rules accordingly.
...
COQMAKEFILE_VERSION:=8.16+alpha
...
#
# There rules can be extended in coq.mk.local
...
# extension points and coq.mk.local
printenv::
	$(warning printenv is deprecated)
	$(warning write extensions in coq.mk.local or include coq.mk.conf)
	@echo 'COQLIB = $(COQLIB)'
...
# file you can extend the merlin-hook target in coq.mk.local
.merlin:
	$(SHOW)'FILL .merlin'
...
# Users can create coq.mk.local-late to hook into double-colon rules
# or add other needed Makefile code, using defined
# variables if necessary.
-include coq.mk.local-late
